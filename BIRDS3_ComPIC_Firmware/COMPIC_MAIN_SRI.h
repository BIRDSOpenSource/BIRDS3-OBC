...
#use rs232(baud=4800, parity=N, xmit=PIN_B3, rcv=PIN_B4, bits=8, stream=RP_CP)    //UART________RESET-PIC
#use rs232(baud=9600, parity=N, xmit=PIN_B1, rcv=PIN_B2, bits=8, stream=MP_CP)    //UART________MAIN-PIC   
//_______________________________________________________________________________________________________________
